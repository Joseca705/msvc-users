...
(300, 300, now(), '2025/03/25', 6, true, 1, 1, now(), 0, 'ACTIVE'),
(150, 150, now(), '2025/03/24', 16, true, 2, 1, now(), 0, 'ACTIVE'),
(250, 250, now(), '2025/03/23', 15, true, 3, 4, now(), 0, 'ACTIVE'),
(120, 120, now(), '2025/03/29', 15.50, true, 4, 3, now(), 0, 'ACTIVE'),
(220, 220, now(), '2025/03/28', 26, true, 5, 6, now(), 0, 'ACTIVE'),
(180, 180, now(), '2025/03/27', 36, true, 6, 3, now(), 0, 'ACTIVE'),
(200, 200, now(), '2025/03/26', 15.20, true, 7, 3, now(), 0, 'ACTIVE'),
(140, 140, now(), '2025/03/25', 11, true, 8, 9, now(), 0, 'ACTIVE'),
(200, 200, now(), '2025/03/24', 21, true, 9, 9, now(), 0, 'ACTIVE'),
(120, 120, now(), '2025/03/23', 30, true, 10, 6, now(), 0, 'ACTIVE'),
(240, 240, now(), '2025/03/29', 51, true, 11, 6, now(), 0, 'ACTIVE'),
(300, 300, now(), '2025/03/28', 100, true, 12, 6, now(), 0, 'ACTIVE'),
(280, 280, now(), '2025/03/27', 22, true, 13, 6, now(), 0, 'ACTIVE'),
(180, 180, now(), '2025/03/26', 12, true, 14, 5, now(), 0, 'ACTIVE'),
(200, 200, now(), '2025/03/25', 10, true, 15, 7, now(), 0, 'ACTIVE'),
(300, 300, now(), '2025/03/24', 8, true, 16, 4, now(), 0, 'ACTIVE'),
(200, 200, now(), '2025/03/23', 4, true, 17, 2, now(), 0, 'ACTIVE'),
(300, 300, now(), '2025/03/29', 5, true, 18, 2, now(), 0, 'ACTIVE'),
(300, 300, now(), '2025/03/28', 15, true, 19, 4, now(), 0, 'ACTIVE'),
(200, 0, now(), '2025/03/27', 26, false, 20, 8, now(), 0, 'ACTIVE'),
(300, 0, now(), '2025/03/26', 33, false, 21, 10, now(), 0, 'ACTIVE');
